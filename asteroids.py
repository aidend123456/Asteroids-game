        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_p:  # Unpause
                    paused = False
        drawText("Paused", white, display_width / 2, display_height / 2, 100)
        pygame.display.update()
        timer.tick(5)


def title_screen():
    """Displays the title screen with buttons."""
    while True:
        gameDisplay.fill(black)
        drawText("ASTEROIDS", white, display_width / 2, display_height / 2 - 100, 100)

        # Draw buttons
        draw_button("Start", display_width / 2 - 100, display_height / 2, 100, 50, black, white, start_game)
        draw_button("Quit", display_width / 2 - 100, display_height / 2 + 100, 100, 50, black, white, quit_game)
...
def draw_button(msg, x, y, width, height, inactive_color, active_color, action=None):
    ...
    drawText(msg, white, x + width / 2, y + height / 2, 30)
    ...
    while gameState != "Exit":
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYUP:
                if event.key == pygame.K_w:
                    player.thrust = False  # Stop thrust when W is released
                if event.key == pygame.K_a or event.key == pygame.K_d:
                    player.rtspd = 0  # Stop rotation when A or D is released
        ...
        if gameState != "Game Over":
            ...
            drawText("Game Over", white, display_width / 2 + 15, display_height / 2 - 100, 100)

            # Draw buttons
            draw_button("Restart", display_width / 2 - 75, display_height / 2, 150, 50, black, white, start_game)
            draw_button("Quit", display_width / 2 - 60, display_height / 2 + 100, 100, 50, black, white, quit_game)

            # Display the score
            drawText("Score: " + str(score), white, display_width / 2 - 20, display_height / 2 + 200, 50)
